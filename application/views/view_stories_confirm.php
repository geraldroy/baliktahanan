	...
	<div class="container">
		<div class="page-header">
			<div class="alert alert-dismissible alert-success" align="center">
			  <button type="button" class="close" data-dismiss="alert"><a href="<?php echo base_url();?>index.php/welcome/stories">×</a></button>
			  <strong>Your donation has been sent. God bless your kind soul!</strong>
			</div>
